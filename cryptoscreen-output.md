...
│   └── 📄 Header.tsx (818 B)
├── 📁 lib/
│   ├── 📄 coingecko.actions.ts (1.06 KB)
│   └── 📄 utils.ts (3.23 KB)
├── 📁 public/
│   ├── 📄 converter.svg (506 B)
│   └── 📄 logo.svg (2.83 MB)
├── 📄 components.json (447 B)
├── 📄 constants.ts (3.06 KB)
...
@layer base {
  * {
  ...
  body {
    @apply bg-dark-700 text-foreground;
  }
}
...
@layer components {
  ...
  header {
    @apply border-b border-dark-400 h-20;
    ...
    .inner {
      ...
      nav {
        ...
        .nav-link {
          @apply px-6 py-5 flex items-center transition-all hover:text-white font-medium h-full text-purple-100 cursor-pointer;
        }
  ...
  #candlestick-chart {
    ...
    .config-button {
      @apply rounded-sm border-0 cursor-pointer px-2.5 py-2 text-xs xl:text-sm text-purple-100 hover:bg-dark-400 hover:text-white;
    }

    .config-button-active {
      @apply rounded-sm px-2.5 py-1.5 border-0 cursor-pointer text-sm text-gray-900 bg-green-500;
    }
  ...
  #coin-card {
    @apply bg-dark-500 hover:bg-dark-400/50 transition-all rounded-lg p-5 border border-purple-600/20 hover:border-purple-600/50 cursor-pointer h-fit;
  ...
  #coin-details-page {
    ...
    .exchange-table {
      ...
      .pair {
        @apply font-medium h-full flex gap-1 py-4 pr-5 space-x-2;

        p {
          @apply truncate max-w-20 md:max-w-30 h-full;
        }
      }
...
.custom-scrollbar [data-slot='table-container']::-webkit-scrollbar {
  width: 7px;
  height: 7px;
}

.custom-scrollbar [data-slot='table-container']::-webkit-scrollbar-track {
  background: transparent;
}

.custom-scrollbar [data-slot='table-container']::-webkit-scrollbar-thumb {
  background: #1e2833;
  border-radius: 8px;
}

.custom-scrollbar [data-slot='table-container']::-webkit-scrollbar-thumb:hover {
  background: #171a34;
}
```
...
- **Created**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `e4928312cdf730b815ff13057682fe97`
- **SHA256**: `49a95bd19c1e913dc857fc831766d9fa83ea6f86ccb3b40752ae8c3ee590a3dc`
- **Encoding**: ASCII
...
- **Extension**: `.tsx`
- **Language**: `typescript`
- **Location**: `components/home/CoinOverview.tsx`
- **Relative Path**: `components/home`
- **Created**: 2026-01-02 08:55:52 (America/Chicago / GMT-06:00)
- **Modified**: 2026-01-02 09:04:15 (America/Chicago / GMT-06:00)
- **MD5**: `6e17a2b1268869289dbc41cd01987606`
- **SHA256**: `431015d8d7bee7013ed5a47560cf555abf0cf98e7ec196ecc635bcd3c22fe25a`
- **Encoding**: ASCII
...
### <a id="📄-components-home-fallback-tsx"></a>📄 `components/home/fallback.tsx`

**File Info:**
- **Size**: 2.94 KB
- **Extension**: `.tsx`
- **Language**: `typescript`
- **Location**: `components/home/fallback.tsx`
- **Relative Path**: `components/home`
- **Created**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `1646651c58a70a3a4e13c0d5131da881`
- **SHA256**: `a4e740928cccc71d57aa8c93f0cd180b7ca887c060d234922e53c4e5517c34d8`
- **Encoding**: ASCII
...
const TrendingCoins = async () => {
	...
	try {
		...
		console.error('Error fetching trending coins')
		console.error(error)
...
- **Created**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `1b339aeaa78100603808436dd1ae9fe2`
- **SHA256**: `3499c3195b236768875a5b06ea2a6f8bc91d69c6f11c8c832517289ca2841b25`
- **Encoding**: ASCII
...
### <a id="📄-components-candlestickchart-tsx"></a>📄 `components/CandlestickChart.tsx`
...
### <a id="📄-components-datatable-tsx"></a>📄 `components/DataTable.tsx`
...
- **Created**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `f37ebdadc30d9cf78cd514191c2b21bd`
- **SHA256**: `1ac732b38b3a77d9cc6425d2a4a45d906ab60b809e0cf3649357e2bc9272c5b3`
- **Encoding**: ASCII
...
- **Created**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `479857a2c7209f8decf0bf36bebfac25`
- **SHA256**: `850ba43cd7cc1d242368bf3ab82b5f5e0ff490b197d9a0e87f01a3e7b35bf16e`
- **Encoding**: ASCII
...
### <a id="📄-lib-coingecko-actions-ts"></a>📄 `lib/coingecko.actions.ts`
...
- **Relative Path**: `lib`
- **Created**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **Modified**: 2026-01-02 08:42:05 (America/Chicago / GMT-06:00)
- **MD5**: `5ac754b9a170f97ecebbb46eb89871fb`
- **SHA256**: `0ce6963a8d69254823fb42fd0ea721979c29e6f8047f015f7fd6515c7f854b78`
- **Encoding**: ASCII
...
export async function fetcher<T>(
  ...
  if (!response.ok) {
    ...
    // Include URL in the error to make debugging 400s easier
    throw new Error(
        `API Error: ${response.status} for ${url}: ${JSON.stringify(errorBody)}`,
      )
  }
...
- **Relative Path**: `lib`
- **Created**: 2025-12-28 09:40:46 (America/Chicago / GMT-06:00)
- **Modified**: 2026-01-02 08:18:37 (America/Chicago / GMT-06:00)
- **MD5**: `80ad98e9adef5476356752850a085cb2`
- **SHA256**: `efc224804e2cff6ede7e777cd6824505c5fe377256def7fea7b22d9f762e7740`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2025-12-28 09:40:40 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-28 09:40:40 (America/Chicago / GMT-06:00)
- **MD5**: `e2ba02b1cfc7f5f85ec3e27da1ead567`
- **SHA256**: `69e0b1e4d27fca1f17d46aa44d3c3e8ced350ada2f03e60f75723fe868851262`
- **Encoding**: ASCII
...
### <a id="📄-constants-ts"></a>📄 `constants.ts`
...
- **Relative Path**: `root`
- **Created**: 2026-01-01 08:16:57 (America/Chicago / GMT-06:00)
- **Modified**: 2026-01-01 08:18:31 (America/Chicago / GMT-06:00)
- **MD5**: `345d0ab47224cad37cc8d84854922880`
- **SHA256**: `4e29d85be32182ffb4ef9cd960465c18f34bad460499bf95d87efb6ec1b0e815`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-28 09:40:55 (America/Chicago / GMT-06:00)
...
- **Created**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-31 23:04:10 (America/Chicago / GMT-06:00)
- **MD5**: `f673e30b330d7d43a5121fc29825e42f`
- **SHA256**: `4f5f1596f3e419acdf28f76551d027ce82ac386756de13d88e151b252d6af7c0`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-28 09:39:15 (America/Chicago / GMT-06:00)
...
- **Relative Path**: `root`
- **Created**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
- **Modified**: 2025-12-28 09:39:18 (America/Chicago / GMT-06:00)
...
- **Location**: `type.d.ts`
- **Relative Path**: `root`
- **Created**: 2026-01-02 08:55:22 (America/Chicago / GMT-06:00)
- **Modified**: 2026-01-02 08:55:22 (America/Chicago / GMT-06:00)
- **MD5**: `597285d160d56eff2a5fe1435117d90b`
- **SHA256**: `d1522decc5476e2e635aa26e9d4a6075c1af1b08a55c83703f62332b31de8587`
- **Encoding**: ASCII
...
Coingecko
dbesqdev
API Key: CG-5T17sTwPqzPLV9B1b2m9dEhf
